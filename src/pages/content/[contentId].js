    ...
    <>
      <div>
        ...
        router.query.type == 5 && dataFCC ? (
          ...
          <AP1 exercise={ejercicioAP1}></AP1>
        ) : router.query.type == 18 ? (
          <TH1 exercise={ejercicioTH}></TH1>
        ) : router.query.type == 19 ? (
          <TP1 exercise={ejercicioTP1}></TP1>
        ) : null}
      </div>
      <Button onClick={() => router.push("/contentSelect?type=" + router.query.type)}>Salir</Button>
    </>
  );
});
