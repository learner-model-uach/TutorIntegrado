...
export const EXPERIMENT_EXERCISES: ExerciseItem[] = [
  ...
  {
    id: "ex-3",
    title: "Ejercicio 3 (E3): Fracción Algebraica",
    instruction: "Copia la siguiente expresión en el campo de respuesta:",
  ...
  {
    id: "ex-4",
    title: "Ejercicio 4 (E4): Fracción Racional con Diferencia de Cuadrados",
    instruction: "Copia la siguiente expresión en el campo de respuesta:",
    targetLatex: "\\frac{x - 3}{x^2 - 9}",
    topic: "Fracciones Racionales (Complejidad Avanzada)",
  },
  {
    id: "ex-5",
    title: "Ejercicio 5 (E5): Ecuación con Raíz Cuadrada y Fracción",
    instruction: "Copia la siguiente expresión en el campo de respuesta:",
    targetLatex: "\\frac{2x - 1}{\\sqrt{x^2 + 16}} = 3",
    topic: "Raíces y Fracciones (Complejidad Avanzada)",
  },
  {
    id: "ex-6",
    title: "Ejercicio 6 (E6): Expresión Mixta Compleja",
    instruction: "Copia la siguiente expresión en el campo de respuesta:",
